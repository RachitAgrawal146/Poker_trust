...
| Title Page | `tog_build/title_page.docx` — **⚠️ IDENTIFIED (author name, affiliation, email). This slot ONLY — NEVER upload to Main Manuscript or Supplementary.** |
| Conflict of Interest | No upload — tick **"None of the authors have a conflict of interest to disclose"** |
| Image | Skip (all figures embedded in the source zip) |
| Supplementary Material for Review | `tog_build/supplementary_FINAL.pdf` (from the closeout pass) |
| LaTeX Supplementary File | Skip |
