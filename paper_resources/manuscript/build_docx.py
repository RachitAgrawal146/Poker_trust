...
ABSTRACT = (
 ...
 r"Language Models augmented with chain-of-thought prompting, per-opponent "
 r"memory, and self-updated strategy notes). Using five random "
 ...
 r"larger step size ($11\times$ greater parameter drift) resulted in an "
